...
static int __attribute__((optimize("O0"))) __dev_open(struct net_device *dev)
{
...
static int __attribute__((optimize("Og"))) __netif_receive_skb_core(struct sk_buff *skb, bool pfmemalloc)
{
